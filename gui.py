...
class MainWindow(QMainWindow):
    ...
    def __init__(self, facade):
        ...
        self.list = []
        self.facade = facade
        if self.facade.loadDB() != None:
            self.list_set = self.facade.loadDB()
        else:
            self.list_set = []
                ...
                for num2 in list_set:
                    if text2 == num2:
                        if text2 == text:
                            ...
                            self.link.list_set = self.facade.print_sets()
                            self.link.update()
